...
| 10/27 | マップ作業・マージ作業 | 小松 | 敵スポーナー2種、ギミック壁３種を実装し、Csvファイルで配置。各担当作業をマージしてメインシーン構築 |
| 10/28 | ヒント表示・マージ作業 | 小松 | ヒントメッセージの表示。各担当作業をマージしてメインシーン構築 |
| 10/29 | アイテム・マージ作業 | 小松 | アイテム２種とヒント作業。各担当作業をマージしてメインシーン構築 |
| 10/30 | アイテム・マージ作業 | 小松 | アイテム配置。Bossスポーナー追加。各担当作業をマージしてメインシーン構築 |
...
| 10/31| UI追加 | 北嶋 | ゲームオーバー前コンティニュー用カウントダウンテキスト、ゲームオーバーシーン追加(暫定) |
| ... | ... | ... | ... |
> ※ 毎日、各メンバーが更新してください。  
